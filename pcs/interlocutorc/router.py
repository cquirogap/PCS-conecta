...
from interlocutorc.views import ApiPrueba,ApiFacturas,RespuestaOrdenApi,RespuestaFacturaApi,MyListView,RespuestaOrdenesApi
...
router_posts.register(prefix='respuesta_ordenes_compra',basename='respuesta_ordenes_compra',viewset=RespuestaOrdenesApi)
