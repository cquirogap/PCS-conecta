...
$(function () {
    ...
    var buscar_indi_casos_estado = function () {
        ...
        $.ajax({
                type: "GET",
                data : {csrfmiddlewaretoken: document.getElementsByName('csrfmiddlewaretoken')[0].value},
                url: '/indicadores/caso_estado/?fecha_inicio='+fecha_inicio+'&fecha_fin='+fecha_fin,
                dataType:'json',
                success: function(data) {
                    // Cargar en tabla
                        casos = data.datos;
                        ...
                        "<div class='row'>"+
                                "<div class='col-md-4 col-sm-6 col-xs-12'>"+
                                  "<div class='info-box'>"+
                                    ...
                                    "<div class='info-box-content'>"+
                                      "<span class='info-box-text'>"+'CASOS PENDIENTES'+"</span>"+
                                ...
                                "<div class='col-md-4 col-sm-6 col-xs-12'>"+
                                  "<div class='info-box'>"+
                                    ...
                                    "<div class='info-box-content'>"+
                                      "<span class='info-box-text'>"+"CASOS EN PROCESO"+"</span>"+
                                      "<span class='info-box-number'>"+data.n_casos_en_proceso+"/"+data.total+"</span>"+
                                      "<strong><i class='fa fa fa-arrow-right'></i>"+data.p_casos_en_proceso+"%"+"</strong><br><br>"+
                                    "</div>"+
                                  "</div>"+
                                "</div>"+
                                "<div class='col-md-4 col-sm-6 col-xs-12'>"+
                                  "<div class='info-box'>"+
                                    ...
                                    "<div class='info-box-content'>"+
                                      "<span class='info-box-text'>"+"CASOS FINALIZADOS"+"</span>"+
